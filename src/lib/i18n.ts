...
const STRINGS = {
  he: {
    ...
    nav_friends: "חברים",
    nav_logout: "התנתקות",
    nav_profile_link: "הפרופיל שלך — עריכת השם ושם המשתמש",
    profile_title: "הפרופיל שלי",
    profile_sub: "השם שחברים רואים, ושם המשתמש שאיתו מתחברים ודרכו מוסיפים אתכם.",
    profile_username_hint:
      "אחרי שינוי מתחברים עם שם המשתמש החדש. 3–20 תווים: אותיות באנגלית, ספרות וקו תחתון.",
    profile_save: "שמירת שינויים",
    profile_saved: "נשמר",
    profile_view_public: "לעמוד הציבורי שלכם",
    nav_groups: "קבוצות",
    ...
    push_title: "המקום הראשון, כל בוקר",
    push_desc: "התראה כל בוקר ב-7:00 עם מי במקום הראשון בטבלה הכללית.",
    push_on: "פעיל — ההתראה תגיע כל בוקר ב-7:00.",
    push_enable: "הפעלת התראות",
    push_disable: "כיבוי התראות",
    push_denied: "ההתראות חסומות לאתר הזה בהגדרות הדפדפן.",
    push_unsupported: "הדפדפן הזה לא יכול לקבל התראות.",
    push_ios_install: "באייפון: שיתוף ← הוספה למסך הבית, לפתוח את FitMeter משם ואז להפעיל כאן.",
    push_error: "לא הצלחנו להפעיל התראות. אפשר לנסות שוב.",
    push_status_on: "פעיל",
    push_status_off: "כבוי",
    install_title: "הוספת FitMeter למסך הבית",
    install_body: "נפתח כמו אפליקציה, בלחיצה אחת — וכך אפשר גם לקבל כל בוקר ב-7:00 התראה על המקום הראשון.",
    install_ios: "באייפון, בספארי: לחיצה על כפתור השיתוף ואז „הוספה למסך הבית”.",
    install_android: "בתפריט הדפדפן (⋮) לבחור „התקנת אפליקציה” או „הוספה למסך הבית”.",
    ...
    more: "עוד",
    less: "פחות",
    sport_search_placeholder: "חיפוש — ספינינג, היירוקס, פאדל…",
    sport_search_label: "סוג האימון",
    sport_no_match: "לא נמצא ספורט כזה.",
    sport_pick_other: "לבחור ״אחר״ ולכתוב בהערה",
    sport_recent: "האחרונים שלך",
    cat_ENDURANCE: "אירובי וסיבולת",
    cat_GYM: "כוח וחדר כושר",
    cat_CLASSES: "סטודיו וגוף-נפש",
    cat_RACQUET: "ספורט מחבטים",
    cat_TEAM: "ספורט קבוצתי",
    cat_COMBAT: "ספורט קרב",
    cat_OUTDOOR: "שטח, מים ושלג",
    cat_OTHER: "אחר",
    ...
    leaderboard_title: "טבלת הדירוג",
    lb_scope_friends: "חברים",
    lb_scope_everyone: "כולם",
    lb_see_more: (n: number) => `הצגת עוד ${n}`,
    lb_see_less: "הצגת פחות",
    lb_your_rank: "המיקום שלך",
    ...
    land_s1_body: "ריצה, אופניים, שחייה, כוח, יוגה, טניס, כדורגל — משך ומרחק בעשר שניות. את הקושי אנחנו מחשבים.",
    ...
    profile_back: "→ לטבלת הדירוג",
    profile_last_7: "7 הימים האחרונים",
    profile_minutes: "דקות",
    profile_active_days: "ימים פעילים",
    profile_total: "אימונים בסך הכול",
    profile_log_heading: "יומן אימונים",
    profile_empty: "עוד לא נרשמו אימונים.",
    profile_notes_friends_only: "הערות על אימונים גלויות לחברים בלבד.",
  ...
  en: {
    ...
    nav_friends: "Friends",
    nav_logout: "Log out",
    nav_profile_link: "Your profile — edit your name and username",
    profile_title: "Your profile",
    profile_sub: "The name friends see, and the username you log in with and get added by.",
    profile_username_hint:
      "After a change you log in with the new username. 3–20 characters: letters, numbers and underscores.",
    ...
    push_title: "Morning winner",
    push_desc: "A notification every day at 7:00 with who's #1 on the everyone leaderboard.",
    push_on: "On — you'll get it every morning at 7:00.",
    push_enable: "Turn on",
    push_disable: "Turn off",
    push_denied: "Notifications are blocked for this site in your browser settings.",
    push_unsupported: "This browser can't receive notifications.",
    push_ios_install: "On iPhone: tap Share → Add to Home Screen, open FitMeter from there, then turn this on.",
    push_error: "Couldn't turn on notifications. Try again.",
    push_status_on: "on",
    push_status_off: "off",
    install_title: "Add FitMeter to your home screen",
    install_body: "It opens like an app, one tap away — and lets you get the 7:00 notification of who's #1.",
    install_ios: "On iPhone, in Safari: tap the Share button, then “Add to Home Screen”.",
    install_android: "Open your browser menu (⋮) and choose “Install app” or “Add to Home screen”.",
    ...
    more: "More",
    less: "Less",
    sport_search_placeholder: "Search — spin, hyrox, padel…",
    sport_search_label: "Workout type",
    sport_no_match: "No sport matches that.",
    sport_pick_other: "Pick “Other” and add a note",
    sport_recent: "Your recent sports",
    cat_ENDURANCE: "Cardio & endurance",
    cat_GYM: "Gym & strength",
    cat_CLASSES: "Classes & mind-body",
    cat_RACQUET: "Racquet sports",
    cat_TEAM: "Team sports",
    cat_COMBAT: "Combat sports",
    cat_OUTDOOR: "Outdoor, water & snow",
    cat_OTHER: "Other",
    ...
    lb_scope_friends: "Friends",
    lb_scope_everyone: "Everyone",
    lb_see_more: (n: number) => `See ${n} more`,
    lb_see_less: "Show less",
    lb_your_rank: "Your position",
    ...
    land_s1_body: "Running, cycling, swimming, lifting, yoga, tennis, football — minutes and distance in ten seconds. We work out the difficulty.",
    ...
    profile_last_7: "Last 7 days",
    profile_minutes: "Minutes",
    profile_active_days: "Active days",
    profile_total: "All-time workouts",
    profile_log_heading: "Workout log",
    profile_empty: "No workouts logged yet.",
    profile_notes_friends_only: "Workout notes are visible to friends only.",
