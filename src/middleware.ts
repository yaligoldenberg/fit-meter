...
const PROTECTED_PATHS = ["/dashboard", "/history", "/friends", "/leaderboard", "/profile"];
...
export const config = {
  matcher: ["/dashboard/:path*", "/history/:path*", "/friends/:path*", "/leaderboard/:path*", "/profile/:path*", "/login", "/register"],
};
